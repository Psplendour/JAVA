...
public class ArrayList5 {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Traversing list through List Iterator:");  //Here, element iterates in reverse order 
        ListIterator<String> list1=list.listIterator();      //Note: By default the argument of the listIterator Method is 0
